...
const EmergencyBar = () => (
  <div className="bg-foreground text-background py-3 px-6 text-[10px] font-black uppercase tracking-[0.3em] z-[60] relative">
    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
      ...
      <a
        href="tel:7733533050"
        className="flex items-center gap-2 text-secondary hover:text-background hover:bg-secondary px-4 py-1 rounded-full transition-all border border-secondary/20 group"
      >
